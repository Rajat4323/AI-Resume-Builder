...
const page = () => {
      ...
      <section>
        <div className="py-8 px-6 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12 md:px-10">
          ...
          <div className="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
            ...
            <Link
              href="https://github.com/Rajat4323/AI-Resume-Builder.git"
  ...
  <h2 className="text-md text-gray-500">Generate resume in just 3 steps</h2>

  <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3 md:px-24">
    {/* Step 1 */}
    <div className="cursor-pointer p-8 border border-gray-100 rounded-3xl bg-white shadow-xl max-md:shadow-xl shadow-gray-600/10 hover:shadow-gray-600/15 transition-shadow duration-300">
      <div className="flex justify-center items-center">
        <AtomIcon className="h-10 w-10 text-primary-700" />
      </div>
      <h2 className="mt-4 text-xl font-bold text-black">Create Your Template</h2>
    ...
    <div className="cursor-pointer p-8 border border-gray-100 rounded-3xl bg-white shadow-xl max-md:shadow-md shadow-gray-600/10 hover:shadow-gray-600/15 transition-shadow duration-300">
      ...
      <h2 className="mt-4 text-xl font-bold text-black">Update Your Information</h2>
      <p className="mt-1 text-sm text-gray-600">
        Enter your personal details, work experience, education, project and skills into the provided form. Our AI assists you in filling out each section accurately and effectively.
      </p>
    </div>
    ...
    <div className="cursor-pointer p-8 border border-gray-100 rounded-3xl bg-white shadow-xl max-md:shadow-md shadow-gray-600/10 hover:shadow-gray-600/15 transition-shadow duration-300">
      ...
      <h2 className="mt-4 text-xl font-bold text-black">Share Your Resume</h2>
      <p className="mt-1 text-sm text-gray-600">
    ...
    >
      ...
      <footer className="backdrop-blur-md w-full">
        <div className="w-full mx-auto text-center max-w-screen-xl p-4 flex max-md:flex-col md:items-center md:justify-between">
          ...
          <Link href="https://github.com/Rajat4323" className="me-4 md:me-6">
